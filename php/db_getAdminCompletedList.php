<?php
    ...
    $query_insert_result = "INSERT INTO #RESULT SELECT CONVERT(VARCHAR(10), prrq.DTStamp, 101) AS Completed, "
                        ...
                        . "LEFT JOIN [DEVDCENTER].[dbo].[Catalog] AS ctlg ON prrq.PrintRequestID = ctlg.PrintRequestID "
                        . "LEFT JOIN [DEVDCENTER].[dbo].[JobStatusDup] AS jstc ON ctlg.JobStatusDupID = jstc.JobStatusDupID "
