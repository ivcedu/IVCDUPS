<?php
    ...
    $query = "INSERT INTO [IVCDCENTER].[dbo].[DropOff] (PrintRequestID, JobStatusDupID, DepartmentID, Pages, Quantity, DateNeeded, TimeNeeded, "
                ...
                . "VALUES ('$PrintRequestID', '$JobStatusDupID', '$DepartmentID', '$Pages', '$Quantity', '$DateNeeded', '$TimeNeeded', "
                . "'$PaperSizeID', '$DuplexID', '$PaperColorID', '$CoverColorID', '$ColorCopy', '$FrontCover', '$BackCover', '$Confidential', '$ThreeHolePunch', '$Staple', '$Cut', '$TotalPrint', '$TotalCost', '$Note')";  
