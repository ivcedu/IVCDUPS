<?php
    ...
    $query = "INSERT INTO [".$dbDatabase."].[dbo].[Duplicating] (PrintRequestID, JobStatusDupID, CostCenterID, Quantity, DateNeeded, TimeNeeded, PaperSizeID, DuplexID, PaperColorID, CoverColorID, ColorCopy, "
                . "FrontCover, BackCover, Confidential, ThreeHolePunch, Staple, Cut, BindingID, Booklet, FirstPgColorPrint, LastPgColorPrint, TotalPrint, TotalCost, Note) "
                . "VALUES ('$PrintRequestID', '$JobStatusDupID', '$CostCenterID', '$Quantity', '$DateNeeded', '$TimeNeeded', '$PaperSizeID', '$DuplexID', '$PaperColorID', '$CoverColorID', '$ColorCopy', "
                . "'$FrontCover', '$BackCover', '$Confidential', '$ThreeHolePunch', '$Staple', '$Cut', '$BindingID', '$Booklet', '$FirstPgColorPrint', '$LastPgColorPrint', '$TotalPrint', '$TotalCost', '$Note')";  
