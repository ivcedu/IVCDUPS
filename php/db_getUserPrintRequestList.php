<?php
    ...
    $query_insert_result = "INSERT INTO #RESULT SELECT CONVERT(VARCHAR(10), prrq.DTStamp, 101) AS Created, "
                        ...
                        . "CASE WHEN (prrq.DeviceTypeID = 1 AND (pltt.JobStatusPlotID = 1 OR pltt.JobStatusPlotID = 2)) OR (prrq.DeviceTypeID = 2 AND dupl.JobStatusDupID = 1) OR (prrq.DeviceTypeID = 4 AND catg.JobStatusDupID = 1) "
                        . "THEN '<a href=# id=''edit_request_id_' + CONVERT(NVARCHAR(255), prrq.PrintRequestID) + '''><i class=''iconic iconic-sm iconic-lock-unlocked''></i></a>' "
